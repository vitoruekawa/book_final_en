...
なお，負荷の抵抗の変化量は\FIGref{fig:P1load}と\FIGref{fig:P3load}の両者でほぼ等しいが，生じる周波数偏差の値は異なっている。
...
\red{関数名とmファイルの名前が対応していない？あと下のプログラムの14行目ではfunc\_ex4が呼ばれている。}
...
さらに，系統全体でキルヒホッフの法則である\req{eq:ohmY2}の代数方程式系が成り立つ。
用いられるすべての変数をまとめて
\begin{align*}
x = \begin{bmatrix}
