...
\begin{figure}[t]
  ...
  \begin{minipage}{0.49\linewidth}
    ...
    \subcaption{ 実線：$\Delta \omega^{\rm lin}$， 破線：$\Delta \hat{\omega}^{\rm lin}$~[pu]}
    \medskip
  \end{minipage}
  \begin{minipage}{0.49\linewidth}
    \centering
    \includegraphics[width = 1.0\linewidth]{figs/deltaspa}
    \subcaption{ 実線：$\delta^{\rm lin}$，破線：${\hat{\delta}}^{\rm lin}$~[rad] }
    \medskip
  \end{minipage}
 \begin{minipage}{0.49\linewidth}
    \centering
    \includegraphics[width = 1.0\linewidth]{figs/Espa}
    \subcaption{ 実線：$E^{\rm lin}$，破線：$\hat{E}^{\rm lin}$~[pu] }
    \medskip
  \end{minipage}
  \begin{minipage}{0.49\linewidth}
    \centering
    \includegraphics[width = 1.0\linewidth]{figs/Pspa}
    \subcaption{ 実線：$P^{\rm lin}$，破線：$\hat{P}^{\rm lin}$~[pu] }
    \medskip
  \end{minipage}
  }
  \medskip
