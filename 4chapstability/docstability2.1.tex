...
\begin{example}[並列された安定な1次系の受動性]\label{ex:psF}
...
\begin{example}[並列された安定な1次系の平衡点に依らない受動性]\label{ex:eipsF}
...
\]
でなければならない．
この不等式は，$W_{x^{\star}}(x)$が定義域$\mathcal{X}$において凸関数（\red{付録？？}）であるならば満たされる．
...
\end{equation}
と表せる．
なお，関数の凸性とヘッセ行列の関係については\red{付録？？}を参照されたい．
...
%\nabla^2 W(x) := 
%\mat{
%\frac{\partial^2 W}{\partial^2 x_1} & \cdots & \frac{\partial^2 W}{\partial x_1 \partial x_{|\mathcal{I}_{\rm G}|}} \\
%\vdots & \ddots & \vdots \\
%\frac{\partial^2 W}{\partial x_{|\mathcal{I}_{\rm G}|} \partial x_1} & \cdots & \frac{\partial^2 W}{\partial^2 x_{|\mathcal{I}_{\rm G}|}}
%}
%\]
