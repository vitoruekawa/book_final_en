...
\begin{example}[Numerical stability analysis of linear approximation model]\label{ex:linsyssim}
...
\begin{definition}[Stability of a square matrix]
\label{def:matsta}
...
\begin{definition}[Passivity of a linear system]\label{def:passivelin}
