...
\begin{theorem}[Positive realness of the transfer function of an electrical subsystem]
\label{thm:EdynNI}
...
\begin{lemma}[Necessary condition for the small signal stability of a second-order oscillator system]\label{thm:2ndsys}
...
\begin{theorem}[Small signal stability of the linear approximation model]\label{thm:sync}
