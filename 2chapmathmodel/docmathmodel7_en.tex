...
used. Here, the voltage phasor is considered an input from the electrical power
system to the generator $i$. In addition, the current phasor becomes an output
from the generator to the electrical power system:
